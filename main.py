...
PLAYER_DETECTION_MODEL_PATH = os.path.join(PARENT_DIR, 'model/football-player-detection.pt')
PITCH_DETECTION_MODEL_PATH = os.path.join(PARENT_DIR, 'model/football-pitch-detection.pt')
BALL_DETECTION_MODEL_PATH = os.path.join(PARENT_DIR, 'model/football-ball-detection.pt')
